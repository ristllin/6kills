...
3. **Refute, don't just re-read.** For every surviving finding, *actively try to disprove it*.
   ...
   breadth is what actually kills false positives; a narrow re-read of the same lines merely
...
Report survivors as **high-confidence leads a human must confirm**: even dedicated red-team
agents resolve only ~13% of real CVEs end-to-end.
